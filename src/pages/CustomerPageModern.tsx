...
const ItemDetailModal: React.FC<{
    ...
    const handleRadioSelect = (addon: Addon) => {
        setSelectedAddons(prev => {
            ...
            // Clicar de novo no mesmo desmarca (permite trocar de ideia sem escolher outro).
                        ...
                        {(settings?.modernGroups || []).map((group: any) => (
                            ...
                            >
                                <div className="w-full h-full bg-gray-950 rounded-[12px] overflow-hidden relative flex items-center justify-center">
                                    ...
                                    <span className="relative z-10 text-xs md:text-xl font-black uppercase tracking-wider text-white drop-shadow-[0_2px_8px_rgba(0,0,0,1)] text-center px-2 group-hover:text-amber-300 transition-colors">
                                        {group.name}
                                    </span>
                                </div>
                            </button>
