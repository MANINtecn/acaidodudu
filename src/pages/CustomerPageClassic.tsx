...
const CustomerPage: React.FC = () => {
    ...
    // Sem valor padrao de proposito -- forma de pagamento obrigatoria, mesma
    // correcao de CustomerPageModern.tsx (Ikarus, 23/09/2026).
                ...
                if (addr) {
                    ...
                    if (deliveryZones && deliveryZones.length > 0) {
                        const matchedZone = deliveryZones.find(z => 
                            addr.toLowerCase().includes(z.neighborhood_name.toLowerCase())
                        );
                        if (matchedZone) {
    ...
    const handleRepeatOrder = async (customItems?: CartItem[], observation?: string) => {
        ...
        try {
            ...
            // ⚠️ Somar ADICIONAIS e COMBO, igual ao subtotal da tela.
